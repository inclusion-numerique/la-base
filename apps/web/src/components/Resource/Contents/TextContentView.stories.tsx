...
export default {
  ...
  component: TextContentView,
} as Meta<typeof TextContentView>

type Story = StoryObj<typeof TextContentView>

const Template = (props: ComponentProps<typeof TextContentView>) => (
  <ResourceWrapper>
    <TextContentView {...props} />
  </ResourceWrapper>
)

const render = (props: ComponentProps<typeof TextContentView>) => (
  <Template {...props} />
)
