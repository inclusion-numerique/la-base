...
const contentSecurityPolicy = `
  ...
  } https://${PublicWebAppConfig.ProConnect.hostname} https://sentry.incubateur.anct.gouv.fr/ https://sentry.incubateur.net https://openmaptiles.geo.data.gouv.fr https://openmaptiles.github.io https://aides-territoires.beta.gouv.fr https://recherche-entreprises.api.gouv.fr https://api-adresse.data.gouv.fr;
