...
export const acceptedBaseJoinRequest = {
  text: ({
    adminName,
    baseTitle,
  }: {
    ...
    `${adminName} a accepté votre demande de rejoindre la base ${baseTitle}`,
  mjml: ({
    url,
    adminName,
    baseTitle,
    ...
    renderToMjml(
      <LayoutWithFooter
        ...
        preview={`${adminName} a accepté votre demande de rejoindre la base ${baseTitle}`}
      >
        <MjmlSection paddingTop={0}>
          <MjmlColumn>
            <MjmlText
              ...
              lineHeight="36px"
            >
              {adminName} a accepté votre demande de rejoindre la base&nbsp;
              {baseTitle}
            </MjmlText>
            <MjmlText fontWeight="400" fontSize="16px" color="#3A3A3A">
              En rejoignant cette base, vous pourrez maintenant :
              <br />
              <br />- Créer & publier des ressources
              <br />- Contribuer à des ressources publiées sur cette base
