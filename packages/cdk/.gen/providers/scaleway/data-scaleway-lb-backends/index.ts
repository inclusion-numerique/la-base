// https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/lb_backends
...
export interface DataScalewayLbBackendsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/lb_backends#id DataScalewayLbBackends#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/lb_backends scaleway_lb_backends}
*/
export class DataScalewayLbBackends extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayLbBackends that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/lb_backends#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/lb_backends scaleway_lb_backends} Data Source
  *
  * @param scope The scope in which to define this construct
