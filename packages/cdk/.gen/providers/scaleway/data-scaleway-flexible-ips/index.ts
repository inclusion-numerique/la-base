// https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/flexible_ips
...
export interface DataScalewayFlexibleIpsConfig extends cdktf.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/flexible_ips#id DataScalewayFlexibleIps#id}
  *
...
/**
* Represents a {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/flexible_ips scaleway_flexible_ips}
*/
export class DataScalewayFlexibleIps extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataScalewayFlexibleIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/flexible_ips#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/scaleway/scaleway/2.81.0/docs/data-sources/flexible_ips scaleway_flexible_ips} Data Source
  *
  * @param scope The scope in which to define this construct
